...
class ResolverTests(unittest.TestCase):
    ...
    def test_normalization_and_alias_resolution(self):
        ...
        result = self.resolver.resolve_library("BBC_CORE")
        self.assertEqual(result.status, "resolved")
        self.assertEqual(result.entity["id"], "bbcso-core")
    ...
    def test_filename_metadata_resolution(self):
        ...
        self.assertEqual(result["library"]["id"], "bbcso-core")
    ...
    def test_contextual_alias_overrides_global_alias(self):
        result = self.resolver.resolve_articulation("cuiv", context="bbcso-core")
        self.assertEqual(result.status, "resolved")
